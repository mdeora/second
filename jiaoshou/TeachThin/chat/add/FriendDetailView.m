...
-(void)renderUser:(NSMutableArray *)array telNo:(NSString *)telNo{
    ...
    //设置头像
    [self.userImageView setImageWithURL:[NSURL URLWithString:picUrl] placeholderImage:[UIImage imageNamed:@"chatListCellHead.png"] options:SDWebImageDownloaderLowPriority|SDWebImageRetryFailed|SDWebImageRefreshCached];
    ...
    self.phoneLabel.text = [NSString stringWithFormat:@"手机号:%@",telNo];
}
