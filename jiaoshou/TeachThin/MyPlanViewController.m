...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    switch (indexPath.section) {
        case 0:
        {
            ...
            tf1.placeholder = [_dict valueForKey:@"breakfast"];
            ...
            case 1:
        {
            ...
            tf2.placeholder = [_dict valueForKey:@"breakfastadd"];
            ...
            case 2:
        {
            ...
            tf3.placeholder = [_dict valueForKey:@"lunch"];
            ...
            case 3:
        {
            ...
            tf4.placeholder = [_dict valueForKey:@"lunchadd"];
            ...
            case 4:
        {
            ...
            tf5.placeholder = [_dict valueForKey:@"dinner"];
            ...
            case 5:
        {
            ...
            tf6.placeholder = [_dict valueForKey:@"dinneradd"];
...
-(void)sureBtnClick:(id)sender
{
    ...
    {
        breakfast = [NSString stringWithFormat:@"%@",tf1.placeholder];
    }else
    {
        breakfast = [NSString stringWithFormat:@"%@",tf1.text];
    }
    if(tf2.text.length==0)
    {
        breakfastadd = [NSString stringWithFormat:@"%@",tf2.placeholder];
    }else
    {
        breakfastadd = [NSString stringWithFormat:@"%@",tf2.text];
    }
    if(tf3.text.length==0)
    {
        lunch = [NSString stringWithFormat:@"%@",tf3.placeholder];
    }else
    {
        lunch = [NSString stringWithFormat:@"%@",tf3.text];
    }
    if(tf4.text.length==0)
    {
        lunchadd = [NSString stringWithFormat:@"%@",tf4.placeholder];
    }else
    {
        lunchadd = [NSString stringWithFormat:@"%@",tf4.text];
    }
    if(tf5.text.length==0)
    {
        dinner = [NSString stringWithFormat:@"%@",tf5.placeholder];
    }else
    {
        dinner = [NSString stringWithFormat:@"%@",tf5.text];
    }
    if(tf6.text.length==0)
    {
        dinneradd = [NSString stringWithFormat:@"%@",tf6.placeholder];
    }else
    {
        dinneradd = [NSString stringWithFormat:@"%@",tf6.text];
    }
